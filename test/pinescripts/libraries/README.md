...
| `tradingview-zigzag-7.pine` | `TradingView/ZigZag/7` | TradingView — official [ZigZag library publication](https://www.tradingview.com/script/bzIRuGXC-ZigZag/), **MPL-2.0** (license header retained) | Verbatim v7 (2023-10-26) of the exact version `auto-pitchfork.pine` imports, fetched from TradingView's public pine-facade endpoint for the publication. Exercises UDT field defaults, exported + private methods, function-form method calls, defaulted method params, `chart.point`, `array<Pivot>`, and drawings held in UDT fields. The current publication is v9; v7 is pinned because import identities are version-exact. |
